...
mydb = mysql.connector.connect(host="localhost",user="root",password="toll@2024",database="toll")
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    _, lp_thr= cv2.threshold(img_gray,100,200,cv2.THRESH_BINARY)
